...
class _MapWithPhoneRotationState extends State<MapWithPhoneRotation> {
  ...
  final LatLng _defaultDestination =
      const LatLng(12.939353, 80.157992); // Default destination
  ...
  /// Update the marker's rotation based on phone orientation
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Distance Travelled: ${(_distanceTravelled / 1000).toStringAsFixed(2)} km',
